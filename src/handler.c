		        ...
		        bool add)
{
  ...
  default:
    logs("SYSERR: Unknown apply adjust attempt (handler.c, affect_modify).");
    break;
...
void char_from_room(struct char_data * ch)
{
  ...
  if (ch == NULL || ch->in_room == NOWHERE) {
    logs("SYSERR: NULL or NOWHERE in handler.c, char_from_room");
    exit(1);
  }
...
void char_to_room(struct char_data * ch, int room)
{
  if (!ch || room < 0 || room > top_of_world)
    logs("SYSERR: Illegal value(s) passed to char_to_room");
  else {
...
void obj_to_char(struct obj_data * object, struct char_data * ch)
{
  if (object && ch) {
    ...
    logs("SYSERR: NULL obj or char passed to obj_to_char");
}
...
void obj_from_char(struct obj_data * object)
{
  ...
  if (object == NULL) {
    logs("SYSERR: NULL object passed to obj_from_char");
    return;
  }
...
void equip_char(struct char_data * ch, struct obj_data * obj, int pos)
{
  ...
  if (obj->carried_by) {
    logs("SYSERR: EQUIP: Obj is carried_by when equip.");
    return;
  }
  if (obj->in_room != NOWHERE) {
    logs("SYSERR: EQUIP: Obj is in_room when equip.");
    return;
  }
  ...
  if (ch->in_room != NOWHERE) {
    ...
    logs("SYSERR: ch->in_room = NOWHERE when equipping char.");
...
void obj_to_room(struct obj_data * object, int room)
{
  if (!object || room < 0 || room > top_of_world)
    logs("SYSERR: Illegal value(s) passed to obj_to_room");
  else {
...
void obj_from_room(struct obj_data * object)
{
  ...
  if (!object || object->in_room == NOWHERE) {
    logs("SYSERR: NULL object or obj not in a room passed to obj_from_room");
    return;
  }
...
void obj_to_obj(struct obj_data * obj, struct obj_data * obj_to)
{
  ...
  if (!obj || !obj_to || obj == obj_to) {
    logs("SYSERR: NULL object or same source and target obj passed to obj_to_obj");
    return;
  }
...
void obj_from_obj(struct obj_data * obj)
{
  ...
  if (obj->in_obj == NULL) {
    logs("error (handler.c): trying to illegally extract obj from obj");
    return;
  }
  obj_from = obj->in_obj;
...
void extract_obj(struct obj_data * obj)
{
  ...
  if (obj->worn_by != NULL)
    if (unequip_char(obj->worn_by, obj->worn_on) != obj)
      logs("SYSERR: Inconsistent worn_by and worn_on pointers!!");
  if (obj->in_room != NOWHERE)
    obj_from_room(obj);
...
void extract_char(struct char_data * ch)
{
  ...
  if (ch->in_room == NOWHERE) {
    logs("SYSERR: NOWHERE extracting char. (handler.c, extract_char)");
    exit(1);
  }
...
char *money_desc(int amount)
{
  ...
  if (amount <= 0) {
    logs("SYSERR: Try to create negative or 0 money.");
    return NULL;
  }
  if (amount == 1)
